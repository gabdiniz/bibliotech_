...
export function Cadastro() {
  ...
  return (
    <Container fluid className="my-5 cadastro">
      ...
      <hr />
      <Button variant="danger" className="mb-3" onClick={onLoginGoogle}> <img src={googleIcon} alt="Icon do Google" width="24" /> Entrar com o Google</Button>
